  ...
  template: `
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
      ...
      <div class="p-6">
        ...
        <p class="text-blue-600 dark:text-blue-400 font-semibold mb-3">{{ member.position }}</p>
        <p class="text-gray-600 dark:text-gray-300 mb-4">{{ member.description }}</p>
        <div class="flex gap-3">
          ...
          @if (member.github) {
            <a [href]="member.github" target="_blank"
               class="text-gray-900 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100 transition-colors">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
